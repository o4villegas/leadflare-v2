...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "LeadFlare v2.0 - AI-Powered Campaign Management" },
    { name: "description", content: "AI-powered campaign management for call centers. Create, manage, and optimize your lead generation campaigns with OpenAI and Anthropic AI." },
  ];
}
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button 
                ...
                className="bg-green-500 hover:bg-green-600 text-slate-900 px-8 py-4 rounded-lg text-lg font-bold transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-green-500/25"
              >
                Create Campaign Now
              </button>
              <button 
                onClick={handleManageCampaigns}
                className="border-2 border-green-500 hover:border-green-400 text-green-400 hover:text-green-300 hover:bg-green-500/10 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-200"
              >
                Manage Campaigns
              </button>
            </div>
